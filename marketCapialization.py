...
#This function transforms the data frame by adding columns for Market Capitalization in GBP, EUR, and INR, rounded to 2 decimal places, based on the exchange rate information shared as a CSV file.

def load_to_csv(df, output_path):
    df.to_csv(output_path)

# This function loads the transformed data frame to an output CSV file.
...
# This function runs queries on the database table.
